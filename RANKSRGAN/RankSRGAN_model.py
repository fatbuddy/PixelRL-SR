...
import RANKSRGAN.networks as networks
import RANKSRGAN.lr_scheduler as lr_scheduler
from .base_model import BaseModel
from RANKSRGAN.loss import GANLoss
...
class SRGANModel(BaseModel):
    ...
    def feed_data(self, data, need_GT=True):
        # self.var_L = data[0].cuda()  # LQ
        self.var_L = data[0].cuda()  # TODO Change to cuda
